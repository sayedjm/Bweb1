        ...
        for (const key in articles) {
            ...
            const articleHtml = `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-secondary btn-sm" onclick="toggleAbstract('${key}')">Show Abstract
                        </button>
                    </td>
                    <td>
                        <button type="button" class="btn btn-secondary btn-sm">
                            <a href="${value.link}" target="_blank" style="color: white; text-decoration: none;">View on PubMed</a>
                        </button>
                    </td>
                </tr>
                <tr>
