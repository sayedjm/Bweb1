...
from dashboard.python_script.plots.line_plot_all import get_all_lines_plot
...
def get_data(request):
    ...
    plot_line_all = get_all_lines_plot()
    context = {"covid_data": covid_data, 'plot_geo': plot_geo, 'plot_line_all': plot_line_all}
